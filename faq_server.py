...
# ??‰øÆÊ≠£Ôºö‰Ωø?®Áõ∏Â∞çË∑ØÂæëÔ??¨Ê???Render ?ΩËÉΩÊ≠?¢∫ËÆÄ??
...
async def read_index():
    ...
    return HTMLResponse("<h2>?æ‰??∞Â?Á´ØÊ?Ê°àÔ?Ë´ãÁ¢∫Ë™?ecoco_persistent_faq.html ?®Â?‰∏Ä?ãË??ôÂ§æ??/h2>", status_code=404)
...
async def ai_chat(req: AIChatRequest):
    ...
    if not api_key:
        raise HTTPException(status_code=400, detail="?™Ë®≠ÂÆ?GEMINI_API_KEY?ÇË??®Áí∞Â¢ÉË??∏‰∏≠?†ÂÖ•?®Á? Gemini API ÂØÜÈë∞??)
    ...
    try:
        ...
        prompt = f"""
‰Ω†ÊòØ‰∏Ä‰ΩçÂ?Ê•≠Á? ECOCO (ÈªûÊï∏?ûÈ?Âπ≥Âè∞) ÂÆ¢Ê??©Ê???
‰Ω†Á??∑Ë≤¨?ØÂü∫??ECOCO ?ÑÂ??πÁ∂≤Á´?https://www.ecoco.network/)?ÅÂ??πÁ?Áµ≤Â?‰ª•Â??¨È?Ë≥áË?ÔºåÊ?‰æõÊ?Á¢∫‰??âÁ¶ÆË≤åÁ?ÂÆ¢Ê??ûË???
Ë´ãÁõ¥?•‰ª•ÂÆ¢Ê??ÑÂè£?ªÂ?Ë¶ÜÔ??ßÂÆπ?âË©≤Âπ´Âä©Ëß?±∫?®Êà∂?ÑÂ?È°åÔ?‰∏¶ÈÅø?çÁµ¶?∫Êú™Á∂ìË?ÂØ¶Á??øË´æ??
Â¶ÇÊ??èÈ?Ë∂ÖÂá∫ ECOCO ?ÑÁ??çÔ?Ë´ãÂ?Â©âÂ??•„Ä?

?®Êà∂?ÑÂ?È°åÊòØÔºö„Äå{req.query}??
"""
        ...
        raise HTTPException(status_code=500, detail=f"AI ?üÊ?Â§±Ê?: {str(e)}")
